...
output5 = no_digits % 2 == 0 and no_digits <= 10 # bool: True if a has even number of digits but not more than 10 digits

offer1 = price1 - ((price1 * discount1)/100)
offer2 = price2 - ((price2*discount2)/100)
